...
goog.addDependency("../clojure/test/check/generators.js", ['clojure.test.check.generators'], ['goog.testing.PseudoRandom', 'clojure.test.check.rose_tree', 'goog.string', 'cljs.core', 'clojure.test.check.random', 'clojure.string']);
goog.addDependency("../cljs/pprint.js", ['cljs.pprint'], ['goog.string', 'cljs.core', 'goog.string.StringBuffer', 'clojure.string']);
goog.addDependency("../cljs/test.js", ['cljs.test'], ['cljs.core', 'cljs.pprint', 'clojure.string']);
goog.addDependency("../clojure/test/check/clojure_test.js", ['clojure.test.check.clojure_test'], ['cljs.core', 'cljs.test']);
goog.addDependency("../clojure/test/check.js", ['clojure.test.check'], ['clojure.test.check.rose_tree', 'cljs.core', 'clojure.test.check.generators', 'clojure.test.check.random', 'clojure.test.check.clojure_test']);
...
goog.addDependency("../om_tutorial/core.js", ['om_tutorial.core'], ['cljs.core', 'om.dom', 'clojure.test.check.generators', 'clojure.test.check', 'clojure.test.check.properties', 'om.next']);
